...
## Fragment alignment
- [https://academic.oup.com/bioinformatics/article/29/1/15/272537](Star: ultrafast universal RNA-seq aligner)
    - Suffix array (SA) approach to leverage speed of binary searching
    - Requires an index (the SA) to be created prior to aligning

- [https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5600148/](Salmon: fast and bias-aware quantification of transcript expression using dual-phase inference)
    ...
    - Similar in concept and result to [https://www.nature.com/articles/nbt.3519](Near-optimal probabilistic RNA-seq quantification)
